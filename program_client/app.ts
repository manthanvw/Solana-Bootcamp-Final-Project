...
async function main(feePayer: Keypair) {
     ...
     */
     await mintSendAndConfirm({
        ...
        mintOwner: mint.publicKey, // Add the mintOwner parameter here
    });
...
await transferSendAndConfirm({
    ...
    signers: {
        ...
        newOwner: janeDoeWallet, // Add the newOwner parameter
    },
});
     ...
     */
     ...
     await burnSendAndConfirm({
         ...
         signers: {
             feePayer: feePayer,
             owner: janeDoeWallet,
             burnOwner: janeDoeWallet, // Add the burnOwner parameter
         },
     });
     console.info("+==== Burned ====+");
