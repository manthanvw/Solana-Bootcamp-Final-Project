...
pub fn transfer(
    ...
    csl_spl_token::src::cpi::transfer_checked(for_transfer_checked, Default::default(), Default::default())?;

    // Update the Gem metadata with the new owner
    gem.data.assoc_account = Some(new_owner);
